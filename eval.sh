...
# launch evaluation
accelerate launch --multi_gpu  --num_processes $num_processes --mixed_precision fp16 $eval_script --config=$config --nnet_path=/home/dongk/dkgroup/tsk/projects/U-ViT/workdir/celeba64_uvit_small/bertexit/ckpts/140000.ckpt/nnet_ema.pth
