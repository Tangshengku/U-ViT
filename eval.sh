...
# launch evaluation
accelerate launch --multi_gpu  --num_processes $num_processes --mixed_precision fp16 $eval_script --config=$config --nnet_path=/data/tsk/diff/workdir/cifar10_uvit_small/default/ckpts/75000.ckpt/nnet_ema.pth
