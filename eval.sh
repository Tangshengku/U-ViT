...
# launch evaluation
accelerate launch --multi_gpu  --num_processes $num_processes --mixed_precision fp16 $eval_script --config=$config --nnet_path=/home/dongk/dkgroup/tsk/projects/U-ViT/workdir/cifar10_uvit_small/uncertainty-aware/ckpts/250000.ckpt/nnet_ema.pth
