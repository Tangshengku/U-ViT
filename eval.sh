...
export num_processes=8  # the number of gpus you have, e.g., 2
...
# launch evaluation
accelerate launch --multi_gpu  --num_processes $num_processes --mixed_precision fp16 $eval_script --config=$config --nnet_path=/home/dongk/dkgroup/tsk/projects/U-ViT/workdir/celeba64_uvit_small/default/ckpts/85000.ckpt/nnet_ema.pth
